...
import 'upload_project_view_model.dart';
export 'upload_project_view_model.dart';

class UploadProjectViewWidget extends StatefulWidget {
  const UploadProjectViewWidget({super.key});

  @override
  State<UploadProjectViewWidget> createState() =>
      _UploadProjectViewWidgetState();
}

class _UploadProjectViewWidgetState extends State<UploadProjectViewWidget> {
  late UploadProjectViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadProjectViewModel());
