...
import 'add_project_view_model.dart';
export 'add_project_view_model.dart';

class AddProjectViewWidget extends StatefulWidget {
  const AddProjectViewWidget({super.key});

  @override
  State<AddProjectViewWidget> createState() => _AddProjectViewWidgetState();
}

class _AddProjectViewWidgetState extends State<AddProjectViewWidget> {
  late AddProjectViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProjectViewModel());
